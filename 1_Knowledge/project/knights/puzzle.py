...
knowledge3 = And(
    ...
    Implication(BKnight, And(Not(Implication(AKnight, Or(AKnave, AKnight))),
                             Implication(AKnight, Or(AKnave, AKnight)))),
    Implication(BKnave, Not(And(Not(Implication(AKnight, Or(
        AKnave, AKnight))), Implication(AKnight, Or(AKnave, AKnight))))),
